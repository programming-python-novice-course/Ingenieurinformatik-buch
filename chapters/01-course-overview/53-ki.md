...
```{admonition} Hinweis
:::class: note
Wenn Sie KI als Lerncoach nutzen, können Sie damit nachweislich Ihre Lernzeit verkürzen bei gleichbleibendem Lerneffekt (Bassner et al.). Siehe `https://doi.org/10.1016/j.caeai.2025.100537`.
```
