...
In der *objektorientierten Programmierung* bündeln wir **Daten** und deren **Operationen**.
Das heißt: Funktionen, welche wir auf die Daten anwenden wollen, und die Daten selbst werden zusammen in ein sogenanntes *Objekt* gepackt.
