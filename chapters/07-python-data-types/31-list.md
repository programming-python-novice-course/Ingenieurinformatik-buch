...
Listen (engl. [List](https://docs.python.org/3/library/stdtypes.html#list)) ``list`` sind eine der wichtigsten *Datentypen* und zugleich einfachsten [Datenstrukturen](sec-datastructures) in ``Python``.
